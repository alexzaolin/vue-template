...
var axiosFun = function(opt){
	...
	*/
	...
	var third_session_obj = {
		"third_session": storage.getStorage("third_session") //用户唯一标识，每次请求都会被携带
	}
	var params = param.method.toLowerCase()==='get'?Object.assign({},third_session_obj,param.data):third_session_obj;
	/*data是body里面的内容*/
